...
pub fn build(b: *std.Build) void {
    ...
    const config = b.addConfigHeader(.{
        ...
        .HAVE_COSL = true,
        .HAVE_DECL_COSL = true,
        .HAVE_DECL_COSQ = false, //quad math?
        ...
        .HAVE_DECL_SINL = true,
        .HAVE_DECL_SINQ = false, //quad math?
        .HAVE_DECL_SRAND48 = true,
        .HAVE_DLFCN_H = true,
        .HAVE_DOPRNT = null, //Unused?
        .HAVE_DRAND48 = true,
        .HAVE_FCNTL_H = true,
        .HAVE_FENV_H = true,
        .HAVE_GETHRTIME = null, //Solaris?
        .HAVE_GETPAGESIZE = true,
        .HAVE_GETTIMEOFDAY = true,
        .HAVE_HRTIME_T = null, //Solaris?
        ...
        .HAVE_MACH_ABSOLUTE_TIME = if (is_mac) true else null,
        ...
        .HAVE_MPI = null,
        .HAVE_OPENMP = null,
        .HAVE_POSIX_MEMALIGN = if (!is_windows) true else null,
        .HAVE_PTHREAD = null, //Unused?
        .HAVE_PTRDIFF_T = true,
        .HAVE_READ_REAL_TIME = null, //AIX systems?
        .HAVE_SINL = true,
        .HAVE_SNPRINTF = true,
        .HAVE_SQRT = true,
        .HAVE_STDDEF_H = true,
        ...
        .HAVE_STRINGS_H = true,
        .HAVE_STRING_H = true,
        .HAVE_SYSCTL = null, //Outdated on modern curnels
        .HAVE_SYS_STAT_H = true,
        .HAVE_SYS_TIME_H = true,
        .HAVE_SYS_TYPES_H = true,
        .HAVE_TANL = null, //Unused?
        .HAVE_THREADS = use_threads,
        .HAVE_TIME_BASE_TO_TIME = null, //AIX?
        .HAVE_UINTPTR_T = true,
        .HAVE_UNISTD_H = true,
        .HAVE_VPRINTF = true,
        .HAVE__MM_FREE = null, //Intel compiler specific
        .HAVE__MM_MALLOC = null, //Intel compiler specific
        .HAVE__RTC = null, //Cray?
        .LT_OBJDIR = null,
        ...
        .WITH_OUR_MALLOC = if (is_windows) true else null, //Windows doesn't provide a reliable aligned malloc on non-Visual C++ compilers, so use version built into FFTW
